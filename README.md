# Run Playwright CodeceptJS Tests with HyperExecute on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Playwright CodeceptJS tests using HyperExecute. This sample shows how to configure Playwright + CodeceptJS + HyperExecute to run on the TestMu AI cloud.
...
```bash
git clone https://github.com/LambdaTest/HyperExecute-Playwright-CodeceptJs && cd HyperExecute-Playwright-CodeceptJs
npm install
```
