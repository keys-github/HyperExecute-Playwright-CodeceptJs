...
[<img alt="Run in Gitpod" width="200 px" align="center" src="images/Gitpod.svg" />](https://hyperexecute.lambdatest.com/hyperexecute/jobs?type=gitpod&framework=CodeceptJS&frameworkType=PlayWright)
---
...
# How to run Playwright automation tests on HyperExecute (using Playwright-CodeceptJs framework) — TestMu AI (Formerly LambdaTest)

* [Pre-requisites](#pre-requisites)
   - [Download HyperExecute CLI](#download-hyperexecute-cli)
   - [Configure Environment Variables](#configure-environment-variables)

* [Auto-Split Execution with Playwright-CodeceptJs](#auto-split-execution-with-Playwright-CodeceptJs)
   - [Core](#core)
   - [Pre Steps and Dependency Caching](#pre-steps-and-dependency-caching)
   - [Artifacts Management](#artifacts-management)
   - [Test Execution](#test-execution)

* [Matrix Execution with Playwright-CodeceptJs](#matrix-execution-with-Playwright-CodeceptJs)
   - [Core](#core-1)
   - [Pre Steps and Dependency Caching](#pre-steps-and-dependency-caching-1)
   - [Artifacts Management](#artifacts-management-1)
   - [Test Execution](#test-execution-1)

* [Run Playwright-CodeceptJs tests on Windows and Linux platforms](#run-Playwright-CodeceptJs-tests-on-windows-and-linux-platforms)
...
## Auto-Split Execution with Playwright-CodeceptJs
...
# Matrix Execution with Playwright-CodeceptJs
...
Playwright-CodeceptJs js files in the 'Tests' folder contain the Test Scenario run on the HyperExecute grid. In the example, the Test file *tests/test_4.spec.js* run in parallel on the basis of scenario by using the specified input combinations.
...
## Run Playwright-CodeceptJs tests on Windows and Linux platforms
